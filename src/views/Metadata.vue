                            ...
                            <v-row>
                                ...
                                <v-col>
                                    <v-tabs v-model="activeSchema">
                                        <v-tab value="data_schema">Data Schema</v-tab>
                                        <v-tab value="ui_schema">UI Schema</v-tab>
                                    </v-tabs>
                                    <template
                                        v-if="
                                            activeResource &&
...
export default defineComponent({
    ...
    methods: {
        async copy() {
            ...
            const json = JSON.stringify(this.schemas[this.activeResource][this.activeSchema])
            try {
